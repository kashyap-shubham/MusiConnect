  ...
  return (
    ...
    <div className="relative flex items-center justify-center">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute left-[20%] top-[25%] h-65 w-65 animate-float rounded-full bg-linear-to-r from-indigo-200 to-purple-200 opacity-40 blur-3xl" />

        <div className="absolute right-[20%] bottom-[20%] h-55 w-55 animate-float-delayed rounded-full bg-linear-to-r from-pink-200 to-rose-200 opacity-40 blur-3xl" />

      </div>


      {/* music wave background */}
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 -z-10 opacity-[0.06]">
